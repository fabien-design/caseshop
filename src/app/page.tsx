...
export default function Home() {
  return (
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper
          className="pb-24 pt-10 lg:grid-cols-3 sm:pb-32
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                ...
                >
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    <span className="font-semibold">4.8/5</span> (128 reviews)
                  </p>
                </div>
              </div>
            </div>
      ...
      <section>
            <MaxWidthWrapper className="py-24">
                ...
                <div className='mx-auto max-w-6xl px-6 lg:px-8'>
                    ...
                    grid-cols-2 gap-40'>
                        <img src='/arrow.png' alt='arrow img' className='absolute top-[25rem] md:top-1/2
                        -translate-y-1/2 z-10 left-1/2 -translate-x-1/2 rotate-90
                        md:rotate-0' />
                        ...
                        ring-gray-900/10 lg:rounded-2xl'>
                            <img src='/horse.jpg' alt='horse pic' className='rounded-md object-cover

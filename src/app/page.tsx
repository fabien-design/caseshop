...
export default function Home() {
  return (
    <div className='bg-slate-50'>
        <section>
            <MaxWidthWrapper className='pb-24 pt-10 lg:grid-cols-3 sm:pb-32
            lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52'>
                <div className='col-span-2 px-6 lg:px-0 lg:pt-4'>
                    ...
                    flex flex-col items-center lg:items-start'>
                        ...
                        lg:block'>
                            <img src="./snake-1.png" alt="snake img first pic"  className='w-full'/>
                        </div>
                        ...
                        <div className='mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5'>
                            ...
                            sm:items-start'>
                                ...
                                <p className='mt-2 text-sm text-gray-500'><span className='font-semibold'>4.8/5</span> (128 reviews)</p>
                            </div>
                        </div>
                    </div>
                </div>

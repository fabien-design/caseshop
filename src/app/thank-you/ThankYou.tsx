    ...
    return (
        <div className="bg-white">
            ...
            >
                ...
                <div className="mt-10 border-t border-zinc-200">
                    <div className="mt-10 flex flex-auto flex-col">
                        ...
                        <p className="mt-2 text-sm text-zinc-600">
                            ...
                            only need to look good, but also last you for the
                            years to come. We offer a 5-year print guarentee. If
                            you case isn't of the highest quality, we'll replace
                            it for free.
                        </p>
                    </div>
                </div>
                ...
                <div
                    className="flex space-x-6 rounded-xl overflow-hidden mt-4 bg-gray-900/5 
                ...
                <div>
                    ...
                    <div
                        className="grid grid-cols-2 gap-x-6 border-t
                    border-zinc-200 py-10 text-sm"
                    >
                        <div>
                            <p className="font-medium text-gray-900">
                                Payment status
                            </p>
                            <p className="text-zinc-700 mt-2">Paid</p>
                        </div>
                        <div>
                            <p className="font-medium text-gray-900">
                                Shipping Method
